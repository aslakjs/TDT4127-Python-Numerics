...
#by using the "".format() method, you can easily add the representative value after the text
...
#By alternating between '' and "" you can make sure all relevant info is being printed to screen
#In this case I've used '' to let the program know the ""-sign should be printed
