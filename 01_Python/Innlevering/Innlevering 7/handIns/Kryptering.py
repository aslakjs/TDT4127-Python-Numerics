...
def main():
    ...
    secret = encrypt(message,key)
    if not secret:
        #perror('Unable to encrypt') # Uncomment for error-mbox (Not working on Jupyter)
...
Man kan bruke likt antall tengn i nøkkelen som i ordet, og ha oversettelsene i en "ordbok", under dekryptering kan det da koden sjekkes opp mot ordboken for å finne riktig løsning. 
