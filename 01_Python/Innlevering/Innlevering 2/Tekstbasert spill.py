...
while True:
    ans = input('\n\nDu skrur på TVn, og programmet du hater men samboern elsker står på, hva gjør du? ')
    alt = ans.lower() #change all input into lowercase
    
    if (alt == 'ser videre') or (alt == 'fortsett å se') or (alt == 'lar det stå'):
        print('Happy wife, happy life! Hun blir så glad etter å ha sett favorittserien sin sammen med deg at hun baker kake som hun deler med deg.')
    
    elif (alt == 'skifter kanal') or (alt == 'bytter kanal') or (alt == 'velger noe annet'):
        print('Samboeren blir sur, du må sove på sofaen og slite deg igjennom en ny dag med vond rygg.')
    
    elif (alt == 'spørre om å bytte kanal') or (alt == 'spørre om å se noe annet'):
        print('Etter en lang diskusjon vinner du, og du får sett favorittprogrammet ditt!')
